...
public class CakaManagerResourceTest {
    ...
    @MockBean
    private CakaManagerDBClient cakeManagerDBClient;
    ...
    private Cake cake = new Cake(10001l,"Lemon cheesecake", "A cheesecake made of lemon", "https://s3-eu-west-1.amazonaws.com/s3.mediafileserver.co.uk/carnation/WebFiles/RecipeImages/lemoncheesecake_lg.jpg");
    ...
    public void retrieveStudent() throws Exception {
        {
            ...
            Mockito.when(
                    cakeManagerDBClient.getCakeById(Mockito.anyLong())).thenReturn(cake);
